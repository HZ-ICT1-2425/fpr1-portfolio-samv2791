...
<div>
    <section class="myprofileBody">
        ...
        <img id="myprofileIMG2" src="{{asset('images/myprofileCat2.jpg')}}" type="image/jpg" alt="Picture of my cat (1)">
        <img id="myprofileIMG3" src="{{asset('images/myprofileCat1.jpg')}}" type="image/jpg" alt="Picture of my cat (2)">
        <img id="myprofileIMG4" src="{{asset('images/myprofileCat4.jpg')}}" type="image/jpg" alt="Picture of my cat (3)">
        <img id="myprofileIMG5" src="{{asset('images/myprofileCat5.jpg')}}" type="image/jpg" alt="Picture of my cat (4)">
        <img id="myprofileIMG6" src="{{asset('images/myprofileCat8.jpg')}}" type="image/jpg" alt="Picture of my cat (5)">
        <img id="myprofileIMG7" src="{{asset('images/myprofileCat3.jpeg')}}" type="image/jpeg" alt="Picture of my cat (6)">
        <img id="myprofileIMG9" src="{{asset('images/myprofileCat6.jpg')}}" type="image/jpg" alt="Picture of my cat (7)">
    </section>
</div>
</x-main>
