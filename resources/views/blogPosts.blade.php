    ...
    @elseif($id == 2)
        <div id="blogSubDisplay">
            <section class="blogSubText">
                ...
                <p> For opportunities:
                <ul>
                    <li>Building up a solid IT skill set as well as experiencing what it is like to do work for real
                        companies and solve real problems
                    </li>
                </ul>
                </p>
                <!-- THREATS -->
                    ...
                    <div id="blogSubDisplay">
                        <section class="blogSubText">
                            ...
                            <p id="blogExperiencefit">
                                ...
                                mind for me was the website I 'made' during my ICT classes in seconday school. One day
                                we were given
                                the task to create a website to track the nearby weather, which we were supposed to do
                                by using
                                local meters. The normal secondary school ICT lecture consisted of 2 hours of me and my
                                friends
                                doing absolutely anything on the computers other than school work, which didn't change
                                for this
                                project. Until the final moment, The couple weeks we had to complete our websites were
                                spent on
                                making and filling in pointless forms with eachother and playing random games. As we
                                were now
                                rapidly running out of time, we finally decided to get to work, though it didn't take
                                long for us to
                                give up. We had done 0 practice and listened to barely anything our teacher had said
                                over the weeks
                                and didn't understand what we were doing. Eventually, we figured out we could just steal
                                templates
                                off the internet, change some things here and there and call it our own. At the end of
                                it all, we
                                had completely unfunctional websites, but at least they looked nice. We ended up still
                                getting
                                decent grades too so... moral of the story: work smarter not harder I guess
                            </p>
                            <p id="blogSubBottom"><a id="blogGoBack" href="{{route('blog')}}">More posts -></a></p>
                        </section>
                        <img src="{{asset('/images/blogExperience.jpeg')}}" id="blogSubImg"
                             alt="Image about experience">
                    </div>
                @elseif($id == 4)
                    <div id="blogSubDisplay">
                        <section class="blogSubText">
                            ...
                            <p id="blogFeedbackfit">
                                ...
                                teachers and students had a look at it and voiced their opinions and impressions. All in
                                all, it was
                                quite well received, getting comments such as "nice layout" and "cool design", though
                                the validity
                                of the positive feedback is questionable, seeing as people probably didn't want to
                                offend me by
                                saying bad things. Looking at the actual feedback I received on my work, the two main
                                things I heard
                                were to make an individual folder within VSCode for the five blog posts themselves and
                                to work a bit
                                more on some of my code formatting (e.g. adding comments here and there, adding blank
                                lines in my
                                css, organising things a bit). All in all, I'm quite content with the results of my
                                websites first
                                showing. In the coming weeks, I plan to implement the received feedback and add some
                                final touches
                    ...
                    <div id="blogSubDisplay">
                        <section class="blogSubText">
                            ...
                            <p id="blogICTfit">
                                ...
                                as Software Engineering, IT Security, IT Support, Computer Programming and many more.
                                The field has
                                been seeing rapid development, especially in more recent years, and has seen the
                                creation of new
                                types of jobs and roles as a result. For the HBO-ICT programme, the main focuses in
                                terms of
                                specialization are Business IT Consultancy, Software Engineering and Data Science,
                                students being
                                required to choose one of the three in their third year after having built up their
                                skills,
                                knowledge and preferences in the first and second. After completing your study at HZ,
                                you can use
                                your (specialized) knowledge to get into various different jobs, some general ones being
                                IT-Consultancy, Data/Software/Cloud Engineering and Website Front/Back-end development.
                                It is also
                                possible to contine your studies after HZ, further broadening your soft/hard skills and
                                increasing
