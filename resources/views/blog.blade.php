    ...
    <article id="blogContent">
        <section id="blogLink">
            <a href="{{route('blogPage', ['id' => 1])}}">
                <section>
                    <hr id="blogMainHrTop">
                    <img id="blogIMG" src="{{asset('images/blogStudyChoice.jpg')}}" alt="Image about making choices">
                    <h3>Study Choice</h3>
                    <p>I went a bit more into detail regarding my study choice and expectations, click to read more.</p><br>
                </section>
            </a>
        </section>
        ...
        <section id="blogLink">
            <a href="{{route('blogPage', ['id' => 3])}}">
                <section>
                    ...
                    <p>I wrote about what I would say is my only somewhat former experience with programming, click to read more.</p><br>
                </section>
            </a>
        </section>
