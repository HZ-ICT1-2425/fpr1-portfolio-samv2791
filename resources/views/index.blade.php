...
<div>
    ...
    <article class="textHome">
        ...
        <p>
            ...
            <a href="https://hz.nl/en/study-programmes/international-business" target="_blank">International Business (IB) course</a>.
    ...
    <article class="textHome">
        ...
        <ul>
            <li>The general topic and learning of it being more direct; If I'm trying to do or learn something
                coding related, I can instantly see how it's going by simply running my code.</li>
